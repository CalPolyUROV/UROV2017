...
dataObjs = [DataHandling(UI, "PSR", "Pressure", "mbars", 90),
            ...
            DataHandling(UI, "MOT", "M1", "", 250),
            DataHandling(UI, "MOT", "M2", "", 270),
            DataHandling(UI, "MOT", "M3", "", 290),
            DataHandling(UI, "MOT", "M4", "", 310),
            DataHandling(UI, "MOT", "M5", "", 330),
            DataHandling(UI, "MOT", "M6", "", 350),
